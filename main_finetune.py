...
root='/home/lthpc/wyc/wyc/Prun_For_OOD/colored_mnist/checkpoint_2'
...
def train(mlp, lambda_lasso,finetunepath):
...
if True:
    ...
    mlp1 = torch.load("/home/lthpc/wyc/wyc/Prun_For_OOD/colored_mnist/checkpoint_2/nslim_pruned.pth.tar").cuda()
    mlp2 = torch.load("/home/lthpc/wyc/wyc/Prun_For_OOD/colored_mnist/checkpoint_2/bislim_pruned.pth.tar").cuda()
else:
...
train(mlp1, args.lambda_lasso, finetunepath=os.path.join('nslim_'+args.fintune_savepath))
train(mlp2, 0, finetunepath=os.path.join('bislim_'+args.fintune_savepath))
